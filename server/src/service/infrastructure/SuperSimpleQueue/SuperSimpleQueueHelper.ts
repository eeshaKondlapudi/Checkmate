	...
	getHeartbeatJob = () => {
		return async (monitor: Monitor) => {
			try {
				...
				// Step 6. Handle incidents first so escalations can reference the active incident
				...
				// Step 7. Handle notifications, including delayed escalations on later heartbeats
