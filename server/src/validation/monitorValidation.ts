...
const escalatedNotificationValidation = z.object({
...
export const createMonitorBodyValidation = z.object({
	...
	escalatedNotifications: z.array(escalatedNotificationValidation).optional(),
...
const importedMonitorSchema = z.object({
	...
	escalatedNotifications: z.array(escalatedNotificationValidation).default([]),
	secret: z.string().optional(),
